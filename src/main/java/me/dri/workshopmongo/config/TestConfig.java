...
public class TestConfig  implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf .parse("23/01/2003"), "Partiu viagem", "Vou viajar para SP", maria);
        Post post2 = new Post(null, sdf .parse("23/01/2003"), "Bom dia", "Acordei feliz hoje", maria);
